...
\paragraph{Validazione delle Transazioni}
\begin{itemize}
...
\begin{figure}[h!]
        \begin{center}
                \includegraphics[width=0.7\textwidth]{testing_facilities_integrated}
        \end{center}
...
\begin{figure}[h!]
        \begin{center}
                \includegraphics[width=0.7\textwidth]{parallel_operation_simulation}
        \end{center}
...
\textbf{Embedded Audit Modules (EAM):} Il software per l'audit è incorporato direttamente 
...
\begin{figure}[h!]
        \begin{center}
                \includegraphics[width=\textwidth]{audit_hooks}
        \end{center}
        \caption{Audit hooks.}
...
\paragraph*{Analisi e eradicazione} Si cerca di capire cos'è successo e perché è
