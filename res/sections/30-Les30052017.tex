...
È un tipo di controllo dell'input che permette l'laborazione sequenziale di
...
automatici(\textit{batch controls}) sui batch e associati ad un batch file.
...
corrispondano al totale dei pagamenti ricevuti, e la una 
\textbf{riconciliazione},ovvero il trattamento degli errori rilecvati, che può
