...
\subsubsection{Preoccupazi per un piano BCP/DR}
...
\textit{Mean Time To Fail} (MTTF), corrisponde al tempo medio che percorre tra 
l'inizio di due fallimenti.

Il MTTR è il tempo medio necessario per la riparazione, mentre il MTTF è il tempo medio dalla riparazione ad un nuovo fallimento.
