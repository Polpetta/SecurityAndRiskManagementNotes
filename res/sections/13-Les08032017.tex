...
d'esami). Al giorno d'oggi è posibile contenere il disastro grazie a
contrimisure
...
\begin{figure}[h!]
        ...
        \end{center}
        \caption{Grafico che mostra le fasi che portano al ripristino del
servizio regolare.}
\end{figure}
\todo{IMPROVE DESCRIPTION OF IMAGE}
