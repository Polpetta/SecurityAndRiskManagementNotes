...
\begin{itemize}
\item Is called the path of physical access (no perché è la mappa degli accessi
logici)
\item Is primarily used in developing security policies
\item Can be used to determine whether sufficient defense in depth is
implemented (corretta)
...
A personal firewall implemented as parte of the OS or antivirus software
qualifies as a:
