...
La gestione del rischio si suddivide nei seguenti passi:
\begin{enumerate}
...
formule:
 ...
 \item \textit{Monitoring} del rischio
\end{enumerate}
...
\subparagraph*{Impressioni dei dipendenti}
Il 51\% pensa sia accettabile prendere dati dell'azienda perché pensano
che sia accettabile farlo se le aziende non fanno rispettare 
tassativamente le \textit{policy}. 
Il 37\% usano applicazioni di file-sharing come \textit{Dropbox} o 
\textit{Gmail} senza il permesso del datore di lavoro. 
Mentre il 20\%  hanno scaricato proprietà intellettuale della 
azienda sui propri dispositivi mobili.
Infine molti eseguono download illegali sul computer aziendale.

Essenzialmente, c'è poco controllo sui dati, dimostrando come un utente
può avere un atteggiamento malizioso senza troppi problemi.
...
\begin{figure}[t]
 \centering
 \includegraphics[scale=0.75]{systemVulnerabilities}
