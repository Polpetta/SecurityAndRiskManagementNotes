...
\begin{itemize}
\item \textbf{Surge, spikes and sags} (sovraccarico, picchi e cali): 
qualcuno ha collegato un dispositivo alla rete che
...
durata ($< 30$ ms) bastano i surge protector, per durata minore di 30 min
si utilizza un UPS (uninterruptible power supply); per periodi più lunghi
si usa un generatore alternativo di corrente. 
I generatori possono arrivare anche a costare milioni di euro.
