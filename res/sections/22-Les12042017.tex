...
precudono una verifica di \emph{tutti} gli eventi e 
...
Il sottinsieme della populazione usato per
...
Il vantaggio di questo approccio è che si perde la rappresentatività
del campione statistico, ma si troveranno delle evidenze su ciò che
si sta effettivamente cercando.
