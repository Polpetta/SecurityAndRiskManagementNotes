...
Il filtro serve a filtrare le connessioni. \`E identificabile come il livello 0
...
IPSec \`e un protocollo di rete che permette di autenticare e criptare i
...
negoziazioni di chiavi crittografiche. IPSec permette di progettere flussi di
