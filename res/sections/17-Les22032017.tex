...
Di seguito viene riportato un piccolo esempio a passi per rendere pi\`u chiaro
il funzionamento:
\begin{enumerate}
...
$B = g^b \mod p$
 \begin{itemize}
  \item $B = 5^{15} \mod 23 = 19$
 \end{itemize}

 \item Alice computa $s = B^a \mod p$
 \begin{itemize}
  \item $s = 19^6 \mod 23 = 2$
 \end{itemize}

 \item Bob computa $s = A^b \mod p$
 \begin{itemize}
  \item $s = 8^{15} \mod 23 = 2$
 \end{itemize}
...
possibile
rompere una qualsiasi password di 8 caratteri come mostra la tabella
