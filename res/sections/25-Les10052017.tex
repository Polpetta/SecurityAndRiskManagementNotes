...
\paragraph*{Obiettivo di una policy:} descrive \textit{cosa} deve essere soddisfatto.

\paragraph*{Controllo della policy:} tecniche per raggiungere l'obiettivo, suddivise in
\begin{itemize}
...
\paragraph*{Controllo della qualità:} condurre test per validare che il software è 
